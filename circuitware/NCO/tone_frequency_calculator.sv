...
(
    ...
    always_comb begin
        ...
        else if (key13) next_nco_increment_value = 32'b00000011000101000100011010000000; // C5  523.3*32/48E3 = 0.3849 = 0b.01100010100010001101 = 00000_011000101000100011010000000
